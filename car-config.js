window.CAR_CONFIG={
  ...
  steering:{gripMaxAngleDeg:28,driftMaxAngleDeg:60,inputSpeedDegPerSec:150,returnSpeedDegPerSec:210,driftReturnSpeedDegPerSec:50,driftNeutralHoldSlipDeg:8,neutralYawBrake:0.45,neutralFrontForceDecay:2.2},
  ...
  tires:{
    ...
    frontCorneringGain:11.4,
    frontMaxLatAccel:11.6,
    frontForceBuildRate:6.3,
    frontForceReleaseRate:7.8,
